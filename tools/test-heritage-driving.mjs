...
same(restored.requestNavigation('menu'),false);same(restored.pendingNavigation.charge,0);same(restored.pendingNavigation.forfeitsRaceEarnings,true);ok(restored.confirmNavigation());
