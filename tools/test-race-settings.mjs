...
app.setRaceSettings(setup);app.setRouteVariant('route_b');app.setLightingMood('golden');app.setGhostEnabled(false);
...
app.setRaceSettings({startStage:2,cpuDifficulty:'hard',difficulty:'casual',mode:'duel'});app.setRouteVariant('route_c');app.setLightingMood('overcast');
