...
check(FEATURE_STATES['career-backup'] === 'dev' && FEATURE_STATES['roadside-destruction'] === 'dev'
  && Object.keys(FEATURE_STATES).length === 2, 'career backup and roadside destruction are the two staged player features');
