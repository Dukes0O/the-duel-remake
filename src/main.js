...
root.innerHTML = `<div id="stage" class="in-menu"><div id="view3d" aria-label="Three-dimensional driving scene"></div><div class="film-grain"></div><div id="overlay">
  ...
  <main id="menu-screen" class="menu-screen">
    ...
    <footer class="menu-footer"><span class="footer-label">BUILT FOR THE DRIVE</span><div class="controls-strip"><span title="Hold S / Down / LT at rest to reverse. W / Up / RT brakes reverse and returns to first gear."><kbd>W A S D</kbd> DRIVE / REVERSE</span><span><kbd>SPACE</kbd> BOOST</span><span><kbd>C / B / V / X</kbd> FRONT / BACK / RIGHT / LEFT</span><span><kbd>Q / E</kbd> MANUAL SHIFT</span><span><kbd>ESC</kbd> PAUSE</span></div><div class="build-meta"><span id="build-version" class="build-version" title="Build ${escapeHTML(BUILD_VERSION.id)}">BUILD ${escapeHTML(BUILD_VERSION.label)}</span><a class="build-label audio-credits" href="/assets/audio/credits.html" target="_blank" rel="noopener">ASSET CREDITS ↗</a></div></footer>
  </main>
...
function updateMenuScene() {
  ...
  ui['rival-customization'].hidden=!stage.hasRival||!!stage.practice||choices.mode!=='duel';
