...
function updateMenuScene() {
  if(ui['foot-camera-control'])ui['foot-camera-control'].hidden=app.duel.featureFlags?.enabled('wasteland2')!==true;
  if(ui['foot-camera'])ui['foot-camera'].value=app.footCameraMode||'first-person';
