...
export function createArmoryScreen({profile, credits, escapeHTML, getGarageMessage,
  getArmoryCar = () => 'falcone_f42', kitsEnabled = () => false, action}) {
