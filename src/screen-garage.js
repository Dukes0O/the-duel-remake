...
import {getPaintState, paintPresetsFor} from './paint-presets.js';
...
function garageScreen() {
  ...
  const muddyHollowTip=garageCar==='titan_monster'?
    app.getMuddyHollowProgress?.().garageTip:null;
