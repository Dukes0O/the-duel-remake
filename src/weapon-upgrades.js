...
export function purchaseWeaponUpgrade(profile,id){
 const weapons=normalizeWeapons(profile.weapons),level=weapons.levels[id];
 ...
 return {ok:true,profile:{...profile,credits:profile.credits-cost,weapons:{...weapons,levels:{...weapons.levels,[id]:level+1}}},cost};
}
