...
No weapon, armor, or car tuning changed. The sample did not show a clear need for a numeric adjustment. The final check ran on integration `0d59751`, including the parked-car brake fix found during this work and RAID-01 camps.
...
- **RPG:** The car is already stopped. A wounded, stationary rival with 30 armor is 55 m behind, with a clear line of fire. One locked rocket hits and wrecks it. The ambush costs 1.9 s at the 200 m marker but gains 199 m of relative race position by 33 s.
