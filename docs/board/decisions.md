...
- Actual game aiming stretches Rook's vest toward the knees. Bind torso-owned vest, pockets, straps and pack to the chest, with a narrow pelvis blend at the belt. Only actual sleeves, forearms and gloves follow the arm chain. Independent exported-clip tests precede the correction; preserve the accepted neutral geometry.
