...
| --- | --- | --- | --- | --- |
| done | **FIX-04** Restore a passing full run | TOOL | S | Merged; the historical task note remains in Git history |
...
| OLD-D | **Stale handoff docs sent agents to the wrong folder.** The removed `docs/SESSION_HANDOFF.md` had named `C:\Users\kyleb\.codex\worktrees\4555` as active. The older `docs/DECISIONS.md` had described point-to-point stages without laps | Historical docs in Git | Agents read docs first. Wrong docs mean work in the wrong place; current locations are in `docs/OPERATIONS.md` | FND-02, CLEAN-05 |
