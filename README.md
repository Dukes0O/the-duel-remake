...
Club Driver is included and changes no stats. Six fictional specialists cost 1,200–2,200 earned credits, with car-specific acceleration, grip or braking skills of 2–6%. **Axel Storm** unlocks free with the Koenigsegg, including for existing owners. In that car only, he adds 30% handling, 20% suspension, 30% tires and 20% nitro. Selecting an owned driver is a separate, free menu action; an unlock never changes your selection. The race keeps a fixed copy of that selection. No driver reward grants credits. See [driver prices and skills](docs/DRIVERS.md).
...
The game uses Three.js, original procedural 3D models, a licensed detailed concept-car body, generated material maps and recorded engine/tire sounds. Landscapes have blended ground materials, fractured granite, grass, cloud cover and animated coastal foam. City scenes have perspective room interiors, a distant skyline, weathered sidewalks, solid parked cars and local street lighting. Day routes offer Clear, Golden hour and Overcast lighting; night events keep their authored lighting. Drift smoke uses a generated transparent sprite. High quality includes contact shading, glow and edge smoothing. Performance renders directly without those extra passes, with smaller shadows and fewer nearby street lights. It gently adjusts 3D resolution between 80–100% from actual driving frame times, targeting smooth 60 FPS; menus and HUD stay sharp. It does not guess from CPU names or RAM capacity, and it cannot guarantee 60 FPS on every device. Both settings retain the same cars, scenery and physics. It remains a browser arcade game; the city chase is a bounded driving event rather than a full open-world simulation.
